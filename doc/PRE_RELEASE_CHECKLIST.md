...
| 版本 | 日期 | 主要变更 |
|------|------|---------|
| v6.5.1 | 2026-05-24 | 入库单管理系统（ReceiptDetail + 4个云函数action + batchId追溯链）；6页空态CTA引导；orderAdd权益双重扣减修复；orderDetail标签溢出布局修复；**Web管理后台全面升级（Vue3+Vite6+7模块+CSV导出+P0/P1质量修复）** |
